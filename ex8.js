...
function sendDataToThingSpeak(latitude, longitude) {
    var apiUrl = "https://api.thingspeak.com/update?api_key=DSVUBE5555YN6Y1Q&field1=" + latitude + "&field2=" + longitude;
...
function fetchThingSpeakData() {
    var apiUrl = "https://api.thingspeak.com/channels/2519347/feeds.json?api_key=ZWYYQ3CZD1ZWTSP5&results=1";
...
function displayThingSpeakChart() {
    var iframe = '<iframe width="450" height="260" style="border: 1px solid #cccccc;" src="https://thingspeak.com/channels/2519347/charts/1?bgcolor=%23ffffff&color=%23d62020&dynamic=true&results=60&type=line&update=15"></iframe>';
